...
L.Control.Reachability = L.Control.extend({
    options: {
        ...
        expandButtonTooltip: 'Afișează meniu accesibilitate',                           // Tooltip to appear on-hover
        ...
        rangeIntervalsLabel: 'intervale',               // The 'show intervals?' checkbox label
